  ...
  return (
    <div className="app-container">
      ...
      <div className="top-banner-elegant">
        <div className="banner-item"><GemIcon /> <span>Broderie artisanale d'exception</span></div>
        <div className="banner-item"><TruckIcon /> <span>Livraison rapide partout au Maroc</span></div>
        <div className="banner-item"><ShieldCheckIcon /> <span>Paiement à la livraison</span></div>
        <div className="banner-item"><HeadphonesIcon /> <span>Service client 7j/7</span></div>
      </div>
      ...
      <nav className="navbar">
        <div className="nav-logo" onClick={goBackToHome} style={{cursor: 'pointer'}}>
          ...
          <div className="logo-text">
            ...
            <p>L'art de la broderie marocaine</p>
          </div>
        </div>
        ...
        <div className="footer-top">
          <div className="footer-col">
            ...
            <div className="footer-socials">
              ...
              <a href="https://facebook.com/Broderieouazzane" target="_blank" rel="noreferrer" style={{color: 'inherit'}}><FacebookIcon /></a>
            </div>
          </div>
          ...
          <div className="footer-col">
            ...
            <div className="footer-contact-item">
              <a href="tel:0694569123" style={{display: 'flex', alignItems: 'center', gap: '10px', color: 'inherit'}}>
